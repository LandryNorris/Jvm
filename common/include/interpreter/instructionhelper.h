...
#define INSTR_DUP_X1        0x5a //duplicate the top two values on top of the stack. Neither can be a Long/Double.
#define INSTR_DUP_X2        0x5b //duplicate the top of the stack, and place it two or three spots from the top.
